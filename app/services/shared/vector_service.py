"""
Shared vector database service for cross-version compatibility.
Consolidates vector operations from v1 to be used by both v1 and v2.
"""
import chromadb
import numpy as np
...
def get_collection_stats():
    ...
    try:
        ...
        ai_logger.exception("[AI] [컬렉션 통계 조회 실패]")

...
class TestPrefixParser:
    ...
    def test_complete_prefix_in_first_chunk(self, parser):
        ...
        for chunk in chunks:
            ...
            # Should remove the prefix and return clean content
    ...
    def test_prefix_split_across_chunks(self, parser):
        ...
        # First chunk should be empty (part of prefix)
        assert results[0] == ""
        # Second chunk should return content after prefix removal
    ...
    def test_simple_korean_prefix(self, parser):
        ...
        # First chunk should have prefix removed
    ...
    def test_newlines_and_carriage_returns_removal(self, parser):
        ...
        # First chunk should have prefix and whitespace cleaned
        assert results[0] == " 새로운 사람들과"
    ...
    def test_case_sensitivity(self):
        ...
        result2 = parser.process_chunk("QUESTION: 테스트")
        assert result2 == " 테스트"
        
        # Should not match different case
        result3 = parser.process_chunk("question: 테스트")
